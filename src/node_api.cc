...
void node_napi_env__::ThrowNodeApiVersionError(node::Environment* environment,
  ...
  environment->ThrowError(error_message.c_str());
}
...
node::addon_context_register_func get_node_api_context_register_func(
  ...
  if (module_api_version == 9) {
    ...
    node_napi_env__::ThrowNodeApiVersionError(
        node_env, module_name, module_api_version);
    return nullptr;
  }
}
