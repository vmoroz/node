...
static inline void NAPI_CDECL napi_module_register(napi_module* mod) {
  node_api_module_vtable->module_register(mod);
}
...
napi_fatal_error(const char* location,
                 ...
                 const char* message,
                 size_t message_len) {
  node_api_module_vtable->fatal_error(
...
napi_async_init(napi_env env,
                ...
                napi_value async_resource_name,
                napi_async_context* result) {
  return node_api_module_vtable->async_init(
      env, async_resource, async_resource_name, result);
}

static inline napi_status NAPI_CDECL
napi_async_destroy(napi_env env, napi_async_context async_context) {
  return node_api_module_vtable->async_destroy(env, async_context);
}
...
napi_make_callback(napi_env env,
                   ...
                   const napi_value* argv,
                   napi_value* result) {
  return node_api_module_vtable->make_callback(
...
static inline napi_status NAPI_CDECL napi_create_buffer(napi_env env,
                                                        ...
                                                        void** data,
                                                        napi_value* result) {
  return node_api_module_vtable->create_buffer(env, length, data, result);
}
#ifndef NODE_API_NO_EXTERNAL_BUFFERS_ALLOWED
static inline napi_status NAPI_CDECL
napi_create_external_buffer(napi_env env,
                            ...
                            void* finalize_hint,
                            napi_value* result) {
  return node_api_module_vtable->create_external_buffer(
...
node_api_create_buffer_from_arraybuffer(napi_env env,
                                        ...
                                        size_t byte_length,
                                        napi_value* result) {
  return node_api_module_vtable->create_buffer_from_arraybuffer(
...
napi_create_buffer_copy(napi_env env,
                        ...
                        void** result_data,
                        napi_value* result) {
  return node_api_module_vtable->create_buffer_copy(
...
static inline napi_status NAPI_CDECL napi_is_buffer(napi_env env,
                                                    napi_value value,
                                                    bool* result) {
  return node_api_module_vtable->is_buffer(env, value, result);
}
...
static inline napi_status NAPI_CDECL napi_get_buffer_info(napi_env env,
                                                          ...
                                                          void** data,
                                                          size_t* length) {
  return node_api_module_vtable->get_buffer_info(env, value, data, length);
}
...
napi_create_async_work(napi_env env,
                       ...
                       void* data,
                       napi_async_work* result) {
  return node_api_module_vtable->create_async_work(env,
                                                   async_resource,
                                                   async_resource_name,
                                                   execute,
                                                   complete,
...
napi_delete_async_work(napi_env env, napi_async_work work) {
  return node_api_module_vtable->delete_async_work(env, work);
}

static inline napi_status NAPI_CDECL
napi_queue_async_work(node_api_basic_env env, napi_async_work work) {
  return node_api_module_vtable->queue_async_work(env, work);
}

static inline napi_status NAPI_CDECL
napi_cancel_async_work(node_api_basic_env env, napi_async_work work) {
  return node_api_module_vtable->cancel_async_work(env, work);
}

// version management
static inline napi_status NAPI_CDECL napi_get_node_version(
    node_api_basic_env env, const napi_node_version** version) {
  return node_api_module_vtable->get_node_version(env, version);
}
...
static inline napi_status NAPI_CDECL
napi_get_uv_event_loop(node_api_basic_env env, struct uv_loop_s** loop) {
  return node_api_module_vtable->get_uv_event_loop(env, loop);
}
...
static inline napi_status NAPI_CDECL napi_fatal_exception(napi_env env,
                                                          napi_value err) {
  return node_api_module_vtable->fatal_exception(env, err);
}

static inline napi_status NAPI_CDECL napi_add_env_cleanup_hook(
    node_api_basic_env env, napi_cleanup_hook fun, void* arg) {
  return node_api_module_vtable->add_env_cleanup_hook(env, fun, arg);
}

static inline napi_status NAPI_CDECL napi_remove_env_cleanup_hook(
    node_api_basic_env env, napi_cleanup_hook fun, void* arg) {
  return node_api_module_vtable->remove_env_cleanup_hook(env, fun, arg);
}
...
napi_open_callback_scope(napi_env env,
                         ...
                         napi_async_context context,
                         napi_callback_scope* result) {
  return node_api_module_vtable->open_callback_scope(
      env, resource_object, context, result);
}

static inline napi_status NAPI_CDECL
napi_close_callback_scope(napi_env env, napi_callback_scope scope) {
  return node_api_module_vtable->close_callback_scope(env, scope);
}
...
napi_create_threadsafe_function(napi_env env,
                                ...
                                napi_threadsafe_function_call_js call_js_cb,
                                napi_threadsafe_function* result) {
  return node_api_module_vtable->create_threadsafe_function(
      env,
      func,
      async_resource,
      async_resource_name,
...
static inline napi_status NAPI_CDECL napi_get_threadsafe_function_context(
    napi_threadsafe_function func, void** result) {
  return node_api_module_vtable->get_threadsafe_function_context(func, result);
}
...
napi_call_threadsafe_function(napi_threadsafe_function func,
                              void* data,
                              napi_threadsafe_function_call_mode is_blocking) {
  return node_api_module_vtable->call_threadsafe_function(
      func, data, is_blocking);
}

static inline napi_status NAPI_CDECL
napi_acquire_threadsafe_function(napi_threadsafe_function func) {
  return node_api_module_vtable->acquire_threadsafe_function(func);
}

static inline napi_status NAPI_CDECL napi_release_threadsafe_function(
    napi_threadsafe_function func, napi_threadsafe_function_release_mode mode) {
  return node_api_module_vtable->release_threadsafe_function(func, mode);
}

static inline napi_status NAPI_CDECL napi_unref_threadsafe_function(
    node_api_basic_env env, napi_threadsafe_function func) {
  return node_api_module_vtable->unref_threadsafe_function(env, func);
}

static inline napi_status NAPI_CDECL napi_ref_threadsafe_function(
    node_api_basic_env env, napi_threadsafe_function func) {
  return node_api_module_vtable->ref_threadsafe_function(env, func);
}
...
napi_add_async_cleanup_hook(node_api_basic_env env,
                            ...
                            void* arg,
                            napi_async_cleanup_hook_handle* remove_handle) {
  return node_api_module_vtable->add_async_cleanup_hook(
      env, hook, arg, remove_handle);
}

static inline napi_status NAPI_CDECL
napi_remove_async_cleanup_hook(napi_async_cleanup_hook_handle remove_handle) {
  return node_api_module_vtable->remove_async_cleanup_hook(remove_handle);
}
...
static inline napi_status NAPI_CDECL
node_api_get_module_file_name(node_api_basic_env env, const char** result) {
  return node_api_module_vtable->get_module_file_name(env, result);
}
