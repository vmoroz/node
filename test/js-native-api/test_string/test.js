...
assert.strictEqual(test_string.TestStdStringLatin1(empty), empty);
assert.strictEqual(test_string.TestStdStringUtf8(empty), empty);
assert.strictEqual(test_string.TestStdStringUtf16(empty), empty);
...
assert.strictEqual(test_string.TestStdStringLatin1(str1), str1);
assert.strictEqual(test_string.TestStdStringUtf8(str1), str1);
assert.strictEqual(test_string.TestStdStringUtf16(str1), str1);
...
assert.strictEqual(test_string.TestStdStringLatin1(str2), str2);
assert.strictEqual(test_string.TestStdStringUtf8(str2), str2);
assert.strictEqual(test_string.TestStdStringUtf16(str2), str2);
...
assert.strictEqual(test_string.TestStdStringLatin1(str3), str3);
assert.strictEqual(test_string.TestStdStringUtf8(str3), str3);
assert.strictEqual(test_string.TestStdStringUtf16(str3), str3);
...
assert.strictEqual(test_string.TestStdStringLatin1(str4), str4);
assert.strictEqual(test_string.TestStdStringUtf8(str4), str4);
assert.strictEqual(test_string.TestStdStringUtf16(str4), str4);
...
assert.strictEqual(test_string.TestStdStringLatin1(str5), str5);
assert.strictEqual(test_string.TestStdStringUtf8(str5), str5);
assert.strictEqual(test_string.TestStdStringUtf16(str5), str5);
...
assert.strictEqual(test_string.TestStdStringUtf8(str6), str6);
assert.strictEqual(test_string.TestStdStringUtf16(str6), str6);
